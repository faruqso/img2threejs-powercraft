    ...
    <div class="about-page light-mesh-bg">
      <header class="global-header">
        ...
        <div class="header-actions" style="display: flex; align-items: center; gap: 0.75rem;">
          <button class="theme-switch" id="about-theme-toggle" title="Toggle dark mode" aria-label="Toggle theme">
      ...
      <div class="about-content">
        ...
        <section class="about-hero">
          <span class="home-eyebrow">Our Mission</span>
          <h1 class="about-hero-title">We make custom hardware <span class="text-teal">that elevates your brand.</span></h1>
          <p class="about-hero-sub">PowerCraft was founded on the belief that corporate gifting and branded merchandise should be as premium and long-lasting as the products behind them.</p>
        </section>
          ...
          <div class="about-card-row">
            <div class="about-info-card">
              <div class="about-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#008075" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
              </div>
              <h2>Our mission</h2>
            ...
            <div class="about-info-card">
              <div class="about-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#008075" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
              </div>
              <h2>Our product</h2>
            ...
            <div class="about-info-card">
              <div class="about-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#008075" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
              </div>
              <h2>Our customers</h2>
        ...
        <section class="about-section">
          ...
          <div class="about-process">
            ...
            <div class="about-process-arrow">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#008075" stroke-width="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </div>
            <div class="about-process-step">
        ...
        <section class="about-section about-values-section">
          ...
          <div class="about-values-grid">
            <div class="about-value">
              ...
              <strong>Premium hardware only</strong>
            ...
            <div class="about-value">
              ...
              <p>Live pricing, no hidden setup fees, and real lead times — shown upfront in 3D before ordering.</p>
            </div>
            <div class="about-value">
              <span class="about-value-icon">&#9679;</span>
              <strong>Sustainability focus</strong>
              <p>Airline-safe capacities, long-lasting lithium cells, and recycled packaging reduce product waste.</p>
            </div>
            <div class="about-value">
              <span class="about-value-icon">&#9733;</span>
              <strong>Brand-first finish</strong>
              <p>Every detail — surface gloss, port accents, laser alignment — is designed to match your brand guidelines.</p>
            </div>
          </div>
        </section>
        ...
        <section class="about-cta-section">
          <div class="about-cta-card">
            <h2>Ready to build your custom hardware?</h2>
