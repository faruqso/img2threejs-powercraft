...
const SOURCE_REPO =
  import.meta.env.VITE_SOURCE_REPO_URL || 'https://github.com/hoainho/img2threejs-showcase';
const SOURCE_BRANCH = import.meta.env.VITE_SOURCE_BRANCH || 'main';
...
export const demos: DemoEntry[] = [
  {
    ...
    blurb:
      ...
      'matte-and-gloss enclosure, MagSafe charging surface, reference-derived side USB-C with blue tongue ' +
      'and contact pads, an opposing flush power button, circular four-LED display, subtle turntable rotation, ' +
      'and touch-friendly orbit and pinch zoom.',
