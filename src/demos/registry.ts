...
export const demos: DemoEntry[] = [
  {
    ...
    blurb:
      ...
      'matte-and-gloss enclosure, rear magnetic alignment ring, recessed blue USB-C, top USB-C recess, ' +
      'bottom power button and status apertures, circular four-LED display, subtle turntable rotation, ' +
